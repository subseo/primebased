export default {
    root: ({props, context, parent}: any) => ({
        class: [
            ...
            // Plain Button
            {'text-content bg-gray-500 border border-gray-500': props.plain && !props.outlined && !props.text},
            // Plain Text Button
            {'text-content': props.plain && props.text},
            // Plain Outlined Button
            {'text-content border border-gray-500': props.plain && props.outlined},
            // Text Button
